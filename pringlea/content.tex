...
Pringlea est une charte graphique pensée pour produire des documents techniques avec un rendu clair et moderne. Son utilisation est faite pour être simple grâce à l'utilisation d'une classe \LaTeX{} standard. Pringlea est dérivée de la classe Myrille dont elle reprend les éléments et mises en page mais change totalement la palette de couleurs pour s'orienter vers des teintes vert canard.

% ── SECTION 1 : COULEURS ───────────────────────────────────────
\section{Palette de Couleurs}

Cette section détaille l'ensemble des couleurs définies dans la classe de Pringlea. Elles sont organisées par thématique pour faciliter leur utilisation. 
...
La classe Pringlea utilise par défaut un système de notes de bas de page symboliques\footnote{Ceci est un exemple de note de bas de page symbolique.} plutôt que numériques. Cela permet d'éviter toute confusion avec des appels de bibliographie ou des exposants mathématiques, tout en apportant une touche d'élégance éditoriale.
...
La classe Pringlea intègre des boîtes spécifiques pour mettre en valeur les théorèmes, propriétés et définitions. Ces environnements sont numérotés automatiquement par section et supportent les références croisées.
...
La classe Pringlea propose plusieurs environnements pour intégrer des images de manière élégante et cohérente avec la charte graphique. Chaque encadré est conçu pour un usage précis : mise en valeur, comparaison texte-image, note latérale ou figure numérotée.
...
\begin{imgbox}[Pringlea — Pringlea antiscorbutica]{12cm}{pringlea.jpg}
  \footnotesize\color{mid}\textit{Le chou de Kerguelen, plante emblématique qui donne son nom à cette charte graphique.}
\end{imgbox}
...
\imgsidenote{pringlea.jpg}{Cette miniature de la pringlea illustre l'utilisation de la commande \texttt{\textbackslash imgsidenote}, idéale pour associer une petite image à une note informative sans perturber le flux du texte.}
...
\myrfig[width=0.5\linewidth]{pringlea.jpg}{La pringlea (\textit{Pringlea antiscorbutica}), plante éponyme de la charte graphique.}
...
La classe Pringlea intègre un générateur automatique de page de garde. La personnalisation s'effectue de manière claire et centralisée dans le préambule de votre document (avant le \ci{\textbackslash begin\{document\}}), à l'aide de macros dédiées.
