...
\documentclass[theme=betula]{myrtille}
...
\hypersetup{pdftitle={Betula — Charte Graphique}}
\headerleft{Betula \textbf{·} Charte Graphique}
...
Betula est une déclinaison en niveau de gris pour l'impression noir et blanc de la charte graphique Myrtille. Myrtille est une charte graphique pensée pour produire des documents techniques avec un rendu clair et moderne. Son utilisation est faite pour être simple grâce à l'utilisation d'une classe \LaTeX\ standard. 

\subsection{Thèmes alternatifs}
Bien que ce document présente la déclinaison en niveaux de gris (\ci{theme=betula}), la classe embarque nativement d'autres thèmes chromatiques complets que vous pouvez activer lors de l'appel de la classe :
\begin{itemize}
...
Cette section détaille l'ensemble des couleurs définies dans la classe de Myrtille (thème Betula en niveaux de gris). Elles sont organisées par thématique pour faciliter leur utilisation.
...
\begin{imgbox}[Le bouleau (\textit{Betula})]{0.8\linewidth}{pictures/birch.jpg}
    Arbre à l'écorce blanche caractéristique qui donne son nom à cette déclinaison monochrome.
\end{imgbox}

\begin{texblock}
\begin{imgbox}[Légende du titre]{0.8\linewidth}{pictures/birch.jpg}
Texte optionnel sous l'image.
\end{imgbox}
\end{texblock}

\subsection{Image et texte côte à côte (imgfloat)}
\begin{imgfloat}{pictures/birch.jpg}
\textbf{Betula}\\[4pt]
Le bouleau (\textit{Betula}) est un genre d'arbres de la famille des Bétulacées, immédiatement reconnaissable à son écorce argentée et blanche ponctuée de marbrures sombres.

Son nom a été choisi pour cette déclinaison car il évoque naturellement le contraste, la pureté et l'élégance sobre des teintes en niveaux de gris adaptées à une impression noir et blanc optimale.
\end{imgfloat}

\subsection{Note latérale illustrée (\textbackslash imgsidenote)}
\imgsidenote{pictures/birch.jpg}{Cette miniature illustre l'utilisation de la commande \ci{\textbackslash imgsidenote}. Idéale pour associer une petite image à une note informative sans perturber le flux du texte.}
...
\myrfig[width=0.5\linewidth]{pictures/birch.jpg}{Le bouleau (\textit{Betula}), arbre éponyme de cette déclinaison monochrome.}
...
\begin{itemize}
    ...
    \item \textbf{Image \textit{birch.jpg} :} « \textit{Birches} » par \textbf{joeldinda} (\href{https://www.flickr.com/photos/96739609@N00/9516542874}{Source}) sous licence \href{https://creativecommons.org/licenses/by-nc-sa/2.0/}{CC-BY-NC-SA 2.0}.
    \item \textbf{Document PDF :} Ce document est mis à disposition sous licence \href{https://creativecommons.org/licenses/by-nc-sa/4.0/deed.fr}{CC-BY-NC-SA 4.0}.
\end{itemize}
