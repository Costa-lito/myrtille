...
\documentclass[theme=acerola]{myrtille}
...
Acerola est une déclinaison basée sur des teintes rouge cramoisi et bordeaux de la charte graphique Myrtille. Myrtille est une charte graphique pensée pour produire des documents techniques avec un rendu clair et moderne. Son utilisation est faite pour être simple grâce à l'utilisation d'une classe \LaTeX\ standard.

\subsection{Thèmes alternatifs}
Bien que ce document présente la déclinaison en teintes rouge cramoisi et bordeaux (\ci{theme=acerola}), la classe embarque nativement d'autres thèmes chromatiques complets que vous pouvez activer lors de l'appel de la classe :
\begin{itemize}
...
Cette section détaille l'ensemble des couleurs définies dans la classe de Myrtille (thème Acerola en teintes rouge cramoisi et bordeaux). Elles sont organisées par thématique pour faciliter leur utilisation.
...
\subsection{Carte image (\ci{imgbox})}
...
\begin{imgbox}[Acerola — Malpighia emarginata]{12cm}{pictures/acerola.jpg}
...
\subsection{Image et texte côte à côte (\ci{imgfloat})}
...
\begin{imgfloat}{pictures/acerola.jpg}
...
\subsection{Note latérale illustrée (\ci{\textbackslash imgsidenote})}
...
\imgsidenote{pictures/acerola.jpg}{Cette miniature de l'acérola illustre l'utilisation de la commande \ci{\textbackslash imgsidenote}, idéale pour associer une petite image à une note informative sans perturber le flux du texte.}
...
\subsection{Figure numérotée (\ci{\textbackslash myrfig})}
...
\myrfig[width=0.5\linewidth]{pictures/acerola.jpg}{L'acérola (\textit{Malpighia emarginata}), fruit éponyme de la charte graphique.}
